...
const MESSAGES: Record<ParcelSignLocale, ParcelSignMessages> = {
  ko: {
    ...
    errorHelp: '프런트 데스크에 새 인도 링크를 요청해 주세요.',
    linkUnavailable: '링크를 사용할 수 없습니다.',
    loadParcelFailed: '택배 정보를 불러오지 못했습니다.',
    networkError: '네트워크 오류가 발생했습니다.',
    doneTitle: '인도가 완료되었습니다',
  ...
  en: {
    ...
    legal: 'Your signature is used only to confirm parcel receipt.',
